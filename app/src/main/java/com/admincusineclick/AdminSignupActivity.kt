...
import com.admincusineclick.databinding.ActivityAdminSignupBinding
...
//                    Log.w(TAG, "Fetching FCM registration token failed", task.exception)
        ...
        val user = UserModel(userId, username, email, password, restaurantName,firebasetoken=token,location=location)
        //save user data
